...
export default function ProductDetails(props) {
  ...
  //   "price": 100,
  //   "shortDesc": "Handmade with love, our growth charts are made from natural wood, stained with a specially chosen eco-friendly stain and finished with a non-toxic varnish or oil.  Made from top grade pine, hand sanded and stained for a perfect finish.",
